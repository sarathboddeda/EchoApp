...
public class MerchantForgotPassword extends Activity {
    ...
    private class forgetPassword extends AsyncTask<String, String, JSONObject> {
        ...
        protected JSONObject doInBackground(String... strings) {
            ...
            json = JSONParser.makeServiceCall("http://media3.co.in/backend/echoapp/services2/regmerchants.php?function=forgotPassword", 2, nameValuePairs);
            return json;
        ...
        protected void onPostExecute(JSONObject jsonObject) {
            ...
            try {
                ...
                if (result.getString("status").toString().equals("Success")) {
                    ...
                    android.app.AlertDialog.Builder builder = new android.app.AlertDialog.Builder(MerchantForgotPassword.this);
                    builder.setTitle(R.string.alertTitle);
                    builder.setMessage(R.string.frgtEmailSent);
                    builder.setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
                            startActivity(new Intent(MerchantForgotPassword.this, MerchantLogin.class));
    ...
    public void validate(int flowcode) {
        ...
        if (flowcode == 0) {
            if (et_frgpassword.getText().toString().equals("")) {
                Validations.MyAlertBox(MerchantForgotPassword.this, "Please Enter email");
                et_frgpassword.requestFocus();
            } else {
                //Toast.makeText(getBaseContext(), "Invalid Data ", Toast.LENGTH_SHORT).show();
                if (Validations.isConnectedToInternet(MerchantForgotPassword.this)) {
                    //Toast.makeText(getBaseContext(), "internet Data ", Toast.LENGTH_SHORT).show();
                    Log.d("email", et_frgpassword.getText().toString());
                    new MerchantForgotPassword.forgetPassword(et_frgpassword.getText().toString()).execute();
                } else {
                    Validations.MyAlertBox(MerchantForgotPassword.this, "INTERNET CONNECTION FAILED");
                }
            }
        }
